...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">
			주문 번호 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
	...
	<tr>
		...
		<td class="ct_write01">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<a href="/product/getProduct?prodNo=${ purchase.purchaseProd.prodNo }&menu=search">${ purchase.purchaseProd.prodNo } (상세 정보 조회)</a></td>
					<td></td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td width="104" class="ct_write">
			구매자 ID <img	src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
	...
	<tr>
		<td width="104" class="ct_write">결제 방식</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			${ purchase.paymentOption eq '1' ? '계좌이체' : '신용카드' }
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
