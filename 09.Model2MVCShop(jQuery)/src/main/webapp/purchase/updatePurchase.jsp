...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">구매자 ID</td>
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
				...
				<option value="1" ${ purchase.paymentOption eq '1' ? 'selected' : '' }>계좌이체</option>
				<option value="2" ${ purchase.paymentOption eq '2' ? 'selected' : '' }>신용카드</option>
