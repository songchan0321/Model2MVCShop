...
<body>
	...
	<form name="addPurchase" method="post" action="/purchase/addPurchase">
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td width="300" class="ct_write">상품 번호 <img
			...
			<tr>
				<td width="104" class="ct_write">상품 상세정보 <img
					src="/images/ct_icon_red.gif" width="3" height="3"
					align="absmiddle" />
				</td>
				<td bgcolor="D6D6D6" width="1"></td>
			...
			<tr>
				<td width="104" class="ct_write">구매자 ID <img
					src="/images/ct_icon_red.gif" width="3" height="3"
					align="absmiddle" />
				</td>
				<td bgcolor="D6D6D6" width="1"></td>
			...
			<tr>
				...
				<td class="ct_write01"><select name="paymentOption"
					...
					maxLength="20">
						<option value="1" selected="selected">계좌이체</option>
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01"><input type="text" name="dlvyAddr"
					class="ct_input_g" style="width: 100px; height: 19px"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text"
					name="dlvyRequest" class="ct_input_g"
			...
			<tr>
				...
				<td width="200" class="ct_write01"><input type="text"
					readonly="readonly" name="dlvyDate" class="ct_input_g"
